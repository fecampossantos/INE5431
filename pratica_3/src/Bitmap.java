...
public class Bitmap {
    ...
    public void cuiftoBitmap(String filename) throws IOException {
   	...
   	// Método que lê os pixels do arquivo Cuif1 e gera o raster, incluindo no array de bytes do arquivo 
    
    private void cuif1toRaster(byte[] cuiffile, int index) {
   	 	int r, g, b;
   	 	
   	 	// raster mantém uma matriz com resolução igual a da imagem, e cada elemento da matriz é um array de 3 elementos (componentes de cor RGB)
   	 	raster=new int[height][width][3];
