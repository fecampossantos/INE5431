...
public class Bitmap {
    ...
    public void cuiftoBitmap(String filename) throws Exception {
    	...
    	int version = cuiffile[2];
   	 	...
   	 	if (version==1)
   	 		...
   	 		cuif3toRaster(cuiffile, number_of_students*4 + 12);  // Compactado YCbCr com Codifica��o de Huffman
   	 	else if (version==4)
   	 		cuif4toRaster(cuiffile, number_of_students*4 + 12); // Compactado RGB com Codifica��o RLE
   	 	else
    ...
    private void cuif4toRaster(byte[] cuiffile, int index) {
    	...
    	// Dado descompactado em "data" � o array RGB, basta gerar raster e coloca no array de bytes represenando arquivo
    	readRaster(data, 0);
   	}
    ...
    // M�todo para salvar o arquivo em "filename"
